...
<script type="text/javascript">
	$(function() {
		...
		$('#userLoginCombobox').combobox({
			url : sy.contextPath + '/base/syuser!doNotNeedSessionAndSecurity_loginNameComboBox.action',
		...
		$('#userLoginCombogrid').combogrid({
			url : sy.contextPath + '/base/syuser!doNotNeedSessionAndSecurity_loginNameComboGrid.action',
			panelWidth : 500,
			panelHeight : 200,
			idField : 'loginname',
			textField : 'loginname',
