...
<script type="text/javascript" charset="utf-8">
	var lockWindowFun = function() {
		$.post(sy.contextPath + '/base/syuser!doNotNeedSessionAndSecurity_logout.action', function(result) {
...
<div id="sessionInfoDiv" style="position: absolute; right: 10px; top: 5px;">
	<%
		if (sessionInfo != null) {
			out.print(com.somnus.util.base.StringUtil.formateString("欢迎您，{0}", sessionInfo.getUser().getLoginname()));
		}
	%>
</div>
